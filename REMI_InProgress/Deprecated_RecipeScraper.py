...
def main():
    ...
    #if no folder to store linkdocs exists, then submit it
    if not os.path.exists(os.getcwd() + "\\linkdocs"):
            os.mkdir(os.getcwd() + "\\linkdocs")
    ...
    '''
        TODO for chatbot corpus:
            ...
            -change scraping behaivor in main to a queueing system rather than lists/loops
